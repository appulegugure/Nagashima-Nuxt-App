  ...
  <div v-if="false">
    <div class="alert-banner-open">  
      <div id="alert-1" class="flex p-4 mb-4 bg-blue-100 rounded-lg dark:bg-blue-200" role="alert">
        ...
        <ul class="ml-3 text-sm font-medium text-blue-700 dark:text-blue-800">
          <li>
            adminUser => Email::admin@gmail.com,Pw::*
          </li>
          <li>
            adminUser => Email::admin@gmail.com,Pw::*
          </li>
...
<script setup>
  onMounted(()=>{
    const tegetEl = document.getElementById('alert-1')
    const closeBanner = ()=>{tegetEl.classList.add('alert-banner-close')}
    tegetEl.addEventListener('click', ()=>closeBanner());
  })
</script>